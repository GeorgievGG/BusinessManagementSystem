...
namespace BMS.Data.Migrations
{
    ...
    [Migration("20171214165959_Initial")]
            ...
            modelBuilder.Entity("BMS.Models.Contract", b =>
                {
                    ...
                    b.HasOne("BMS.Models.Employee", "Creator")
            ...
            modelBuilder.Entity("BMS.Models.Project", b =>
                {
                    ...
                    b.HasOne("BMS.Models.Inquiry", "Inquiry")
                        .WithOne("Project")
                        .HasForeignKey("BMS.Models.Project", "InquiryId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("BMS.Models.Offer", "Offer")
                        .WithOne("Project")
                        .HasForeignKey("BMS.Models.Project", "OfferId")
                        .OnDelete(DeleteBehavior.Restrict);
                });
